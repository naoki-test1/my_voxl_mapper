...
int main(int argc, char **argv)
{
	...
	if (load_extrinsics_file(en_debug))
		return -1;
	...
	// setup tsdf configs
	// more options in tsdf_integrator.h
	...
	int_config.max_ray_length_m = 6.0; // TODO make this configurable, right now matches TOF_DISTANCE_CUTOFF in voxl_mapper.cc
